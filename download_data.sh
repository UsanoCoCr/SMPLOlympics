# mkdir sample_data
# mkdir -p output output/HumanoidIm/ output/HumanoidIm/phc_3 output/HumanoidIm/phc_comp_3 output/HumanoidIm/pulse_vae_iclr output/HumanoidIm/pulse_vae_x/
...
# gdown https://drive.google.com/uc?id=1TL6uGa_Yjwche7cdpdQr-Ml9211_0rap -O  sample_data/ # basketball states
gdown https://drive.google.com/uc?id=1vUb7-j_UQRGMyqC_uY0YIdy6May297K5 -O  sample_data/ # standing amass x
